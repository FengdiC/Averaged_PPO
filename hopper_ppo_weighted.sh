...
SECONDS=0
python Hyperparam/weighted_ppo_tune.py --seed 396 --log_dir $SCRATCH/avg_discount/ --env 'Hopper-v4' --epochs 500 &
python Hyperparam/weighted_ppo_tune.py --seed 396 --log_dir $SCRATCH/avg_discount/ --env 'Swimmer-v4' --epochs 500 &
python Hyperparam/weighted_ppo_tune.py --seed 396 --log_dir $SCRATCH/avg_discount/ --env 'Reacher-v4' --epochs 500 &
