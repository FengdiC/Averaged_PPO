...
logger.configure(args.log_dir, ['csv'], log_suffix='Hopper-separate-ppo-tune-'+str(args.seed))
...
for seed in seeds:
    ...
    seed=seed,scale=hyperparam['scale'],w_lr=hyperparam['gamma_coef']*hyperparam['vf_lr'])
