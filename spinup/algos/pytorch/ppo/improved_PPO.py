...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    def update():
        ...
        for i in range(train_pi_iters):
            ...
            # update the state-emphasis after each update
            # compute the policy ratio for each data and cumulate them
...
def separate_weighted_ppo(env_fn, actor_critic=core.MLPSeparateWeightedActorCritic, ac_kwargs=dict(), seed=0,
                          steps_per_epoch=4000, epochs=50, gamma=0.99, clip_ratio=0.2, pi_lr=3e-4,
                          vf_lr=1e-3, w_lr=1e-3, train_pi_iters=80, train_v_iters=80, train_w_iters=80, lam=0.97,
                          max_ep_len=1000,
