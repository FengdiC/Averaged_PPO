...
SECONDS=0
python Hyperparam/weighted_ppo_tune.py --seed 107 --log_dir $SCRATCH/avg_discount/ --env 'Ant-v4' --epochs 500 &
python Hyperparam/weighted_ppo_tune.py --seed 107 --log_dir $SCRATCH/avg_discount/ --env 'InvertedDoublePendulum-v4' --epochs 500 &
python Hyperparam/weighted_ppo_tune.py --seed 107 --log_dir $SCRATCH/avg_discount/ --env 'InvertedPendulum-v4' --epochs 500 &
